...
export const ContactSection: React.FC = () => {
  const socials = [
    { icon: Instagram, href: 'https://instagram.com/wavywitny', label: 'Instagram' },
    { icon: Twitter, href: '#', label: 'Twitter' },
    { icon: Music, href: 'https://open.spotify.com/artist/60FotEIEBnJSB4ZW1sS6Ue', label: 'Spotify' },
    { icon: Youtube, href: 'https://www.youtube.com/@wavywitny', label: 'YouTube' },
  ];
  ...
  return (
    <section id="booking" className="bg-black py-32 px-6 text-center">
      <div className="max-w-3xl mx-auto reveal">
        ...
        <a href="mailto:booking@wavywity.com" className="font-display text-3xl md:text-5xl text-gold border-b border-[rgba(201,169,110,0.3)] hover:border-gold transition-colors pb-2">
